...
public class MainActivity extends AppCompatActivity {
            ...
            public void run() {
                ...
                try {
                    ...
                    DatagramPacket packet = new DatagramPacket(buf, buf.length,
                            InetAddress.getByName("192.168.42.54"), 8888);
                    socket.send(packet);
                    socket.close();
    ...
    public void test2(View v){
        new Thread(){
            ...
            public void run() {
                try{
                    Socket socket = new Socket(InetAddress.getByName("192.168.42.56"),9999);
                    socket.close();
    ...
    public void test5(View v){
        new Thread(){
            ...
            public void run() {
                try {
                    URL url = new URL("http://4.bp.blogspot.com/-v9_Z2ikPBBY/Uf40h_z720I/AAAAAAAAAUQ/GLsEW1IxIzs/s1600/Android+tutorials.jpg");
                    HttpURLConnection conn = (HttpURLConnection)url.openConnection();
                    conn.connect();
    ...
    public void test8(View v){
        new Thread(){
            ...
            public void run() {
                try {
                    MultipartUtility mu = new MultipartUtility("http://10.1.6.58/add2.php", "UTF-8");
